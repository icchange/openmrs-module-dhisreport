...
<form action="executeBulkReport.form" method="post">
    <table>
       <%--  <tr>
        ...
        <tr>
        	<td>Number of consecutive dates</td>
        	<td><input type="number" name="consecutive" min="1" value="1" /> </td>
        </tr>
        </tr>
           <tr>
...
<h3><spring:message code="dhisreport.reportDefinitionFor" /></h3>
<c:forEach var="reportDefinition" items="${reportDefinitions}" >
	<h3>${reportType}: ${reportDefinition.name}</h3>
</c:forEach>
